        ...
        try {
            ...
            setTimeout(() => {
                if (window.formHandler) {
                    window.formHandler.updateProgress(25, 'Paso 1 de 4: Documentos');
                }
            }, 100);
        ...
        try {
            ...
            setTimeout(() => {
                if (window.firebaseLoaded && window.firebaseDB) {
                    ...
                    console.warn('Firebase services not ready');
                    this.firebaseReady = false;
                }
            }, 100);
...
// Form navigation functions - Updated for 4 steps
...
window.showContactInfo = () => window.formHandler?.showContactInfo(); // AGREGAR ESTA
...
// Contact step functions - AGREGAR ESTAS
...
window.getAppStatus = () => {
    return {
        ...
        contactStepHandler: window.contactStepHandler ? 'Ready' : 'Not ready', // AGREGAR
        commercialConditionsHandler: window.commercialConditionsHandler ? 'Ready' : 'Not ready', // AGREGAR
