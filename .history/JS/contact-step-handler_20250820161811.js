...
class FormHandler {
    ...
    showCompanyInfo() {
        ...
        this.updateProgress(50, 'Paso 2 de 4: Información de la Empresa');
    ...
    showContactInfo() {
        ...
        // Update progress
        this.updateProgress(100, 'Paso 4 de 4: Datos de Contacto');
    ...
    showDocuments() {
        if (this.currentStep === 'company') {
            // From company to documents
            document.getElementById('company-step').classList.remove('active');
            document.getElementById('documents-step').classList.add('active');
            this.updateProgress(25, 'Paso 1 de 4: Documentos');
            this.currentStep = 'documents';
        } else if (this.currentStep === 'banking') {
            // From banking to company (this is the "back" button behavior)
            document.getElementById('banking-step').classList.remove('active');
            document.getElementById('company-step').classList.add('active');
            this.updateProgress(50, 'Paso 2 de 4: Información de la Empresa');
            this.currentStep = 'company';
        } else if (this.currentStep === 'contact') {
            // From contact to banking (NUEVO)
    ...
    collectFormData() {
        ...
        // Add contact data if handler exists (NUEVO)
        if (window.contactStepHandler) {
    ...
    reset() {
        ...
        ['company-step', 'banking-step', 'contact-step'].forEach(stepId => {
...
// Function for contact step to proceed to submission (NUEVO)
