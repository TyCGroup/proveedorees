...
class GeographicCoverageHandler {
    ...
    populateStateSelect() {
        ...
        this.states.forEach(state => {
            ...
            option.textContent = state.nom_ent;
    ...
    populateCitySelect(stateCode) {
        ...
        municipalities.forEach(municipality => {
            ...
            option.textContent = municipality.nom_mun;
    ...
    showFallbackStates() {
        this.states = [
            { cve_ent: '09', nom_ent: 'Ciudad de México' },
            { cve_ent: '15', nom_ent: 'México' },
            { cve_ent: '14', nom_ent: 'Jalisco' },
            { cve_ent: '19', nom_ent: 'Nuevo León' },
            { cve_ent: '23', nom_ent: 'Quintana Roo' }
        ];
        this.populateStateSelect();
    }
