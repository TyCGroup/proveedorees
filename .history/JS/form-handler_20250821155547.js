...
class FormHandler {
    ...
    collectFormData() {
        ...
        // Get commercial form inputs (NUEVO)
        ...
        // Add commercial data if handler exists (NUEVO)
        if (window.commercialConditionsHandler) {
            formData.commercialData = window.commercialConditionsHandler.getCommercialData();
        }
