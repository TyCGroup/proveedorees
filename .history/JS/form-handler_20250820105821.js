...
class FormHandler {
    ...
    setupBankingListeners() {
        ...
        if (numeroCuentaInput) {
            ...
            numeroCuentaInput.removeEventListener('input', this.handleBankingInput);
            numeroCuentaInput.removeEventListener('blur', this.validateBankingData);
        ...
        if (clabeInput) {
            // Remove existing listeners to avoid duplicates
            clabeInput.removeEventListener('input', this.handleClabeInput);
            clabeInput.removeEventListener('blur', this.validateBankingData);
    ...
    showCompanyInfo() {
        ...
        // Update progress - CORREGIDO: Paso 2 de 3 = 66%
    ...
    // Show documents step - CORREGIDO: Lógica de navegación
    showDocuments() {
...
window.showBankingInfo = () => window.formHandler.showBankingInfo(); // AGREGADO
