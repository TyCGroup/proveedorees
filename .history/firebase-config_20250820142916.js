...
try {
  ...
  // Configure Firestore settings con la nueva API de cache
  const firestoreSettings = {
    cache: firebase.firestore.MemoryPersistentCacheSettings ? 
      firebase.firestore.MemoryPersistentCacheSettings : 
      { 
  ...
  try {
    ...
    console.log('Firestore settings applied with modern cache configuration');
  } catch (settingsError) {
